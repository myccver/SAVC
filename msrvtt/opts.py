...
def parse_opts():
    ...
    parser.add_argument('--lamba1', type=float, default=1.0)
    parser.add_argument('--lamba2', type=float, default=1.0)
    parser.add_argument('--lamba3', type=float, default=1.0)
    parser.add_argument('--lamba4', type=float, default=1.0)
